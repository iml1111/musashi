...
async def create_user_by_admin(
    user: UserCreate, current_user: User = Depends(get_current_admin_user_dependency), db=Depends(get_database)
):
...
async def get_all_users(current_user: User = Depends(get_current_admin_user_dependency), db=Depends(get_database)):
...
async def get_user_by_id(
    user_id: str, current_user: User = Depends(get_current_admin_user_dependency), db=Depends(get_database)
):
...
async def update_current_user(
    user_update: UserUpdate, current_user: User = Depends(get_current_active_user_dependency), db=Depends(get_database)
):
